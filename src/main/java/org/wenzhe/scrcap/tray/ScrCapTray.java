...
public class ScrCapTray {  
  ...
  public static void main(String[] args) {
    if (SystemTray.isSupported()){
      ...
      HotKey.registerCaptureHotKey(HotKey.CAPTURE, ScrCapProps.getSetting().getHotKey());
  ...
  private static MenuItem createAutoChangeHotKeyItem() {
    ...
    item.addActionListener(new ActionListener() {  
      @Override
      public void actionPerformed(ActionEvent e) {
        char oldKey = setting.getSwitchAutoCaptureKey();
  ...
  private static MenuItem createChangeHotKeyItem() {
    ...
    final MenuItem item = new MenuItem(MessageFormat.format(label, setting.getHotKey()));  
    item.addActionListener(new ActionListener() {  
      @Override
      public void actionPerformed(ActionEvent e) {
        char oldKey = setting.getHotKey();
        String newKeyStr = JOptionPane.showInputDialog(
        ...
        setting.setHotKey(newKey);
        HotKey.registerCaptureHotKey(HotKey.CAPTURE, newKey);
        ScrCapProps.save();
        item.setLabel(MessageFormat.format(label, setting.getHotKey()));
      }  
    });
    return item;
  }
